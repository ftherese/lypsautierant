...
\score {
	\relative f'  {
		...
		a16[\( a\) g a] a4 \pespace \pespace \break
		...
		a8[\( a16\) bes] a16[\( a\) g a] a4 \ifIndent
		\times 2/3 { r8_\( a[ a]\) }
...
\score {
	\relative d'  {
		...
		% gloire...
		\break r8 f16[ f] f8.[ \cesureBasse f16] f16[ \cesureBasse f f d] d4
		\ifIndent
		r16 c16[ d f] 
...
\score {
	\relative c''  {
		...
		\break
		% gloire...
		\break r8 c16[ c] c8.[ \cesure c16] c16[ \cesure c c a] a4
		\ifIndent
		r16 c16[ c c] 
