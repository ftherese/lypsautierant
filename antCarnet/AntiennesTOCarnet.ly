...
\score {
	\relative c''  {
		...
		\endBar
		\stemOff g4 a c_\markup \ref "(Mt 4)"
		\endBar 
	}
	\addlyrics {\set stanza = #"(A) "
...
\score {
	\relative f'  {
		...
		\endBar
		\stemOff f4 g a a a a_\markup \ref "(Mc 1)"
		\endBar 
	}
	\addlyrics {\set stanza = #"(B) "
...
\score {
	\relative a'  {
		...
		\endBar
		\stemOff g4 a c_\markup \ref "(Lc 4)"
		\endBar 
	}
	\addlyrics {\set stanza = #"(C) "
...
\score {
	\relative f'  {
		...
		\endBar
		\stemOff f4 g a_\markup \ref "(Mt 5)"
		\endBar 
	}
	\addlyrics {\set stanza = #"(A) "
...
\score {
	\relative f'  {
		...
		\endBar
		\stemOff f4 g a_\markup \ref "(Jr 1)"
		\endBar 
	}
	\addlyrics {\set stanza = #"(C) "
...
\score {
	\relative a'  {
		...
		\times 2/3 { c8[ b c] } a4
		\endBar
		\stemOff f4 a c_\markup \ref "(Mt 5)"
		\endBar 
	}
	\addlyrics {\set stanza = #"(A) "
...
\score {
	\relative a'  {
		...
		\endBar
		\stemOff f4 g a_\markup \ref "(Lc 5)"
		\endBar 
	}
	\addlyrics {\set stanza = #"(C) "
...
\score {
	\relative a'  {
		...
		\endBar
		\noBreak
		\stemOff g4 a c_\markup \ref "(Mt 5)"
		\endBar 
	}
	\addlyrics {\set stanza = #"(A) "
...
\score { \transpose g f {
	\relative c''  {  \key g \major
		...
		\endBar
		\stemOff g4 a b_\markup \ref "(Mc 1)"
		\endBar 
	}
	\addlyrics {\set stanza = #"(B) "
...
\score { 
	\relative c''  {
		...
		\endBar
		\stemOff g,4 a c_\markup \ref "(Lc 6)"
		\endBar 
	}
	\addlyrics {\set stanza = #"(C) "
...
\score {
	\relative c''	{
		...
		c8[ b] g4\( g8\) r8
		\endBar
		\stemOff g4 a c_\markup \ref "(Mc 2)"
		\endBar 
	}
	\addlyrics {\set stanza = #"(B) "
...
\score {
	\relative c''	{
		...
		d8[ d] d8[ c] b4
		\endBar
		\stemOff c4 b c_\markup \ref "(Lc 6)"
		\endBar 
	}
	\addlyrics {\set stanza = #"(C) "
...
\score {
	\relative f'	{
		...
		\endBar
		\stemOff f4 g a_\markup \ref "(Mt 6)"
		\endBar 
	}
	\addlyrics {\set stanza = #"(A) "
...
\score {
	\relative f'	{
		...
		\times 2/3 { f8[ d e] } d4
		\endBar
		\stemOff f4 g a_\markup \ref "(Mc 2)"
		\endBar 
	}
	\addlyrics {\set stanza = #"(B) "
...
\score { \transpose f c {
	\relative f'	{
		...
		\endBar
		\noBreak
		\stemOff f4 g bes_\markup \ref "(Lc 6)"
		\endBar 
	}
	\addlyrics {\set stanza = #"(C) "
...
\score {
	\relative a'	{
		...
		\times 2/3 { g8[ a g] } g4
		\endBar
		\stemOff f4 a c_\markup \ref "(Mt 7)"
		\endBar 
	}
	\addlyrics {\set stanza = #"(A) "
...
\score {
	\relative f'	{
		...
		a16[\( a\) bes g] a4
		\endBar
		\stemOff f4 g a a a a_\markup \ref "(Mc 2)"
		\endBar 
	}
	\addlyrics {\set stanza = #"(B) "
...
\score { \transpose c f { 
	\relative c'	{ \key c \major
		...
		\endBar
		\stemOff c4 d e_\markup \ref "(Lc 7)"
		\endBar 
	}
	\addlyrics {\set stanza = #"(C) "
...
\score {
	\relative c''	{
		...
		\times 2/3 { c8[ a g] } g4
		\endBar
		\stemOff c'4 b c_\markup \ref "(Mt 9)"
		\endBar 
	}
	\addlyrics {\set stanza = #"(A) "
...
\score {
	\relative f'	{
		...
		g4\( g8\) r8
		\endBar
		\stemOff f4 g a_\markup \ref "(Mc 3)"
		\endBar 
	}
	\addlyrics {\set stanza = #"(B) "
...
\score {
	\relative a'	{
		...
		\endBar
		\stemOff f,4 a c_\markup \ref "(Lc 7)"
		\endBar 
	}
	\addlyrics {\set stanza = #"(C) "
...
\score { \transpose a e' {
	\relative d'	{
		...
		r8 d d8[ f] d8[ e] d4
		\endBar
		\stemOff c4 d f_\markup \ref "(Mt 10)"
		\endBar 
	}
	\addlyrics {\set stanza = #"(A) "
...
\score {
	\relative c''	{
		...
		\times 2/3 { a8[ a g] } g4
		\endBar
		\stemOff g4 a c_\markup \ref "(Mc 4)"
		\endBar 
	}
	\addlyrics {\set stanza = #"(B)"
...
\score {
	\relative c''	{
		...
		\endBar
		\stemOff c'4 b c_\markup \ref "(Lc 7)"
		\endBar 
	}
	\addlyrics {\set stanza = #"(C) "
...
\score {
	\relative d'	{
		...
		\endBar
		\noBreak
		\stemOff f4 g a_\markup \ref "(Mt 10)"
		\endBar 
	}
	\addlyrics {\set stanza = #"(A) "
...
\score {
	\relative f'	{
		...
		\endBar
		\stemOff f4 g a_\markup \ref "(Mc 4)"
		\endBar 
	}
	\addlyrics {\set stanza = #"(B) "
...
\score {
	\relative a'	{
		...
		\endBar
		\stemOff f4 a c_\markup \ref "(Lc 9)"
		\endBar 
	}
	\addlyrics {\set stanza = #"(C)"
...
\score {
	\relative f'	{
		...
		f16[ e d e] e4\( d8\) r8
		\endBar
		\stemOff f4 g a a a a_\markup \ref "(Mt 10)"
		\endBar 
	}
	\addlyrics {\set stanza = #"(A) "
...
\score {
	\relative f'	{
		...
		\times 2/3 { e8[ f d] } d4
		\endBar
		\stemOff f4 g a_\markup \ref "(Mc 5)"
		\endBar 
	}
	\addlyrics {\set stanza = #"(B) "
...
\score {
	\relative f'	{
		...
		g8[ f] e8[ c] d4
		\endBar
		\stemOff f4 g a a a a_\markup \ref "(Mt 11)"
		\endBar 
	}
	\addlyrics {\set stanza = #"(A) "
...
\score {
	\relative f'	{
		...
		a16[ f e f] d4\( d8\) r8
		\endBar
		\stemOff f4 g a_\markup \ref "(Mc 6)"
		\endBar 
	}
	\addlyrics {\set stanza = #"(B) "
...
\score {
	\relative f'	{
		...
		\times 2/3 { g8[ a f] } f4
		\endBar
		\stemOff f4 g a_\markup \ref "(Lc 10)"
		\endBar 
	}
	\addlyrics {\set stanza = #"(C) "
...
\score {
	\relative f'	{
		...
		r8 g a8[\( f\)] e4\( d8\) r8
		\endBar
		\stemOff f4 g a_\markup \ref "(Mt 13)"
		\endBar 
	}
	\addlyrics {\set stanza = #"(A) "
...
\score {
	\relative a'	{
		...
		a4\( a8\) r8
		\endBar
		\stemOff f4 a c_\markup \ref "(Mc 6)"
		\endBar 
	}
	\addlyrics {\set stanza = #"(B) "
...
\score {
	\relative a'	{
		...
		e4\( e8\) r8
		\endBar
		\stemOff g4 a c_\markup \ref "(Mt 13)"
		\endBar 
	}
	\addlyrics {\set stanza = #"(A) "
...
\score {
	\relative a'	{
		...
		\times 2/3 { c8[\( b\) c] } a4
		\endBar
		\stemOff f4 a c_\markup \ref "(Mt 13)"
		\endBar 
	}
	\addlyrics {\set stanza = #"(A) "
...
\score {
	\relative a'	{
		...
		g4\( f8\) r8
		\endBar
		\stemOff f4 a c_\markup \ref "(Jn 6)"
		\endBar 
	}
	\addlyrics {\set stanza = #"(B) "
...
\score {
	\relative f'	{
		...
		f8[\( f]\) e8[ f] d4
		\endBar
		\stemOff f4 g a a a a_\markup \ref "(Lc 11)"
		\endBar 
	}
	\addlyrics {\set stanza = #"(C) "
...
\score {
	\relative f'	{
		...
		\endBar
		\stemOff f4 g a_\markup \ref "(Mt 14)"
		\endBar 
	}
	\addlyrics {\set stanza = #"(A) "
...
\score {
	\relative c''	{
		...
		\times 2/3 { a4\( a8\) }
		\endBar
		\stemOff c'4 b c_\markup \ref "(Lc 12)"
		\endBar 
	}
	\addlyrics {\set stanza = #"(C) "
...
\score {
	\relative c''  {
		...
		r8 c c8[ a] g4
		\endBar
		\stemOff c'4 b c_\markup \ref "(Mt 14)"
		\endBar 
	}
	\addlyrics {\set stanza = #"(A) "
...
\score {
	\relative a'  {
		...
		g8[\( f8]\) g4
		\endBar
		\stemOff g4 a c_\markup \ref "(Jn 6)"
		\endBar 
	}
	\addlyrics {\set stanza = #"(B) "
...
\score {
	\relative a'  {
		...
		\times 2/3 { c8[ a g] } g4
		\endBar
		\stemOff g4 a c_\markup \ref "(Lc 12)"
		\endBar 
	}
	\addlyrics {\set stanza = #"(C) "
...
\score {
	\relative a'  {
		...
		r8 g f8[\( g\)] a8[ g] e4
		\endBar
		\stemOff a4 a a_\markup \ref "(Mt 15)"
		\endBar 
	}
	\addlyrics {\set stanza = #"(A) "
...
\score { \transpose d g
	\relative d'  {
		...
		e8[ g] e8[ d] d4
		\endBar
		\stemOff d4 e g_\markup \ref "(Jn 6)"
		\endBar 
	}
	\addlyrics {\set stanza = #"(B) "
...
\score {
	\relative f'  {
		...
		f8[\( d]\) d4
		\endBar
		\stemOff f4 g a_\markup \ref "(Mt 16)"
		\endBar 
	}
	\addlyrics {\set stanza = #"(A) "
...
\score {
	\relative f'  {
		...
		\times 2/3 { f8[\( e\) d] } d4
		\endBar
		\stemOff f4 g a_\markup \ref "(Lc 13)"
		\endBar 
	}
	\addlyrics {\set stanza = #"(C) "
...
\score { \transpose a d'{
	\relative c'  { \key a\minor
		...
		b8[\( a8]\) a4
		\endBar
		\stemOff c'4 d e_\markup \ref "(Mt 16)"
		\endBar 
	}
	\addlyrics {\set stanza = #"(A) "
...
\score {
	\relative f'  {
		...
		f8[ g] e8[ e] g8[ bes] a4
		\endBar
		\stemOff f4 g a a a a_\markup \ref "(Jc 1)"
		\endBar 
	}
	\addlyrics {\set stanza = #"(B) "
...
\score {
	\relative c''  {
		...
		\times 2/3 { g4\( g8\) }
		\endBar
		\stemOff g4 a c_\markup \ref "        (Lc 14)"
		\endBar 
	}
	\addlyrics {\set stanza = #"(C) "
...
\score {
	\relative f'  {
		...
		c16[\cesure c a g] g4
		\endBar
		\stemOff f4 g a a a a_\markup \ref "(Mt 18)"
		\endBar 
	}
	\addlyrics {\set stanza = #"(A) "
...
\score {
	\relative c''  {
		...
		g8[ a] c8[ a] g4\( g8\) r8
		\endBar
		\stemOff g4 a c_\markup \ref "(Jc 2)"
		\endBar 
	}
	\addlyrics {\set stanza = #"(B) "
...
\score {
	\relative a'  {
		...
		a8[\( a\)] g8[ b] a4\( a8\) r8
		\endBar
		\stemOff f4 a c_\markup \ref "(Lc 14)"
		\endBar 
	}
	\addlyrics {\set stanza = #"(C) "
...
\score { \transpose c f, {
	\relative c''  {
		...
		g8[ b] a4
		\endBar
		\stemOff g4 a c_\markup \ref "(Mt 18)"
		\endBar 
	}
	\addlyrics {\set stanza = #"(A) "
...
\score {
	\relative a'  {
		...
		a8[ g] a4
		\endBar
		\stemOff f4 a c_\markup \ref "(Lc 15)"
		\endBar 
	}
	\addlyrics {\set stanza = #"(C) "
...
\score { \transpose c f, {
	\relative c''  {
		...
		a4\( a8\) r8
		\endBar
		\stemOff g4 a c_\markup \ref "(Mt 20)"
		\endBar 
	}
	\addlyrics {\set stanza = #"(A) "
...
\score { \transpose g f {
	\relative c''  { \key g \major
		...
		b4\( b8\) r8
		\endBar
		\stemOff g,4 b d_\markup \ref "(Mc 9)"
		\endBar 
	}
	\addlyrics {\set stanza = #"(B) "
...
\score {
	\relative f'  {
		...
		g8[ a] g4
		\endBar
		\stemOff f4 g a a a a_\markup \ref "(Lc 16)"
		\endBar 
	}
	\addlyrics {\set stanza = #"(C) "
...
\score {
	\relative a'  {
		...
		g8[ a] g4
		\endBar
		\stemOff g4 a c_\markup \ref "(Mt 21)"
		\endBar 
	}
	\addlyrics {\set stanza = #"(A) "
...
\score {
	\relative a'  {
		...
		e4\( e8\) r8
		\endBar
		\stemOff a4 a a_\markup \ref "(Mc 9)"
		\endBar 
	}
	\addlyrics {\set stanza = #"(B) "
...
\score {
	\relative a'  {
		...
		\times 2/3 { g8[ g f] } e4
		\endBar
		\stemOff g4 a c_\markup \ref "(Lc 16)"
		\endBar 
	}
	\addlyrics {\set stanza = #"(C) "
...
\score {
	\relative a'  {
		...
		g4\( e8\) r8
		\endBar
		\stemOff a4 a a_\markup \ref "(Mc 10)"
		\endBar 
	}
	\addlyrics {
...
\score {
	\relative f'  {
		...
		e8[ f] d4\( d8\) r8
		\endBar
		\stemOff c4 d f a a a_\markup \ref "(Lc 17)"
		\endBar 
	}
	\addlyrics {\set stanza = #"(C) "
...
\score {
	\relative f'  {
		...
		bes8[ g] a4\( a8\) r8
		\endBar
		\stemOff f4 g a_\markup \ref "(Mt 22)"
		\endBar 
	}
	\addlyrics {\set stanza = #"(A) "
...
\score {
	\relative f'  {
		...
		d8[ e] d4
		\endBar
		\stemOff f4 g a_\markup \ref "(Mc 10)"
		\endBar 
	}
	\addlyrics {\set stanza = #"(B) "
...
\score {
	\relative c''  {
		...
		a4\( a8\) r8
		\endBar
		\stemOff c'4 b c_\markup \ref "(2Tm 2)"
		\endBar 
	}
	\addlyrics {\set stanza = #"(C) "
...
\score { \transpose a d {
	\relative c''  { \key a\minor
		...
		c8[ a] a4
		\endBar
		\stemOff g4 a c_\markup \ref "(Mt 22)"
		\endBar 
	}
	\addlyrics {\set stanza = #"(A) "
...
\score {
	\relative f'  {
		...
		d4\( d8\) r8
		\endBar
		\stemOff c4 d f_\markup \ref "(Lc 18)"
		\endBar 
	}
	\addlyrics {\set stanza = #"(C) "
...
\score {
	\relative d'  {
		...
		d8[\( e8]\) d4 
		\endBar
		\stemOff c4 d f_\markup \ref "(Mc 12)"
		\endBar 
	}
	\addlyrics {\set stanza = #"(A) "
...
\score {
	\relative d'  {
		...
		\times 2/3 { f8[ e f] } d4
		\endBar
		\stemOff c4 d f_\markup \ref "(Jr 31)"
		\endBar 
	}
	\addlyrics {\set stanza = #"(B) "
...
\score { \transpose f c {
	\relative f'  {
		...
		g8[ f] f4
		\endBar
		\stemOff f4 g bes_\markup \ref "(Mt 23)"
		\endBar 
	}
	\addlyrics {\set stanza = #"(A) "
...
\score {
	\relative f'  {
		...
		d8[ e] d4
		\endBar
		\stemOff f4 g a a a a_\markup \ref "(Lc 19)"
		\endBar 
	}
	\addlyrics {\set stanza = #"(C) "
...
\score {
	\relative f'  {
		...
		a8[ g] a4\( a8\) r8
		\endBar
		\stemOff f4 a c_\markup \ref "(Mt 25)"
		\endBar 
	}
	\addlyrics {\set stanza = #"(A) "
...
\score {
	\relative c''  {
		...
		g4\( g8\) r8
		\endBar
		\stemOff g4 a c_\markup \ref "(Mc 12)"
		\endBar 
	}
	\addlyrics {\set stanza = #"(B) "
...
\score {
	\relative f'  {
		...
		\times 2/3 { f8[ e f] } d4
		\endBar
		\stemOff f4 g a a a a_\markup \ref "(Lc 20)"
		\endBar 
	}
	\addlyrics {\set stanza = #"(C) "
...
\score { \transpose g  f {
	\relative c''  { \key g \major
		...
		\endBar
		\stemOff g4 a b_\markup \ref "(Mt 25)"
		\endBar 
	}
	\addlyrics {\set stanza = #"(A) "
...
\score {
	\relative f'  {
		...
		e8[ f] d4\( d8\) r8
		\endBar
		\stemOff f4 g a_\markup \ref "(Mc 13)"
		\endBar 
	}
	\addlyrics {\set stanza = #"(B) "
...
\score {
	\relative c''  {
		...
		a8[ g] a4
		\endBar
		\stemOff f4 a c_\markup \ref "(Lc 21)"
		\endBar 
	}
	\addlyrics {\set stanza = #"(C) "
...
\score { \transpose e a, {
	\relative c''  {
		...
		d8[\( b\)] a4
		\endBar
		\stemOff c'4 d e e e e_\markup \ref "(Mt 25)"
		\endBar 
	}
	\addlyrics {\set stanza = #"(A) "
...
\score { \transpose a d' {
	\relative d'  {
		...
		a4
		\endBar
		\stemOff c'4 d e e e e_\markup \ref "(Jn 18)"
		\endBar 
	}
	\addlyrics {\set stanza = #"(B) "
...
\score {
	\relative a'  {
		...
		\times 2/3 { f8[ d c] }
		d8[ e] e4
		\endBar\stemOff a4 a a_\markup \ref "(Lc 23)"
		\endBar 
	}
	\addlyrics {\set stanza = #"(C) "
