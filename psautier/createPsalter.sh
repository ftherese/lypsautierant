...
./modes.pl "revisedGrailPsalter/Psalm\ 11900" five a_prime b | sed -f sedaccents > Psalm0117.tex;
./modes.pl "revisedGrailPsalter/Psalm\ 11901" one b a | sed -f sedaccents > Psalm0118.tex;
./modes.pl "revisedGrailPsalter/Psalm\ 11902" three a b | sed -f sedaccents > Psalm0118.tex;
./modes.pl "revisedGrailPsalter/Psalm\ 11903" two a b | sed -f sedaccents > Psalm0118.tex;
./modes.pl "revisedGrailPsalter/Psalm\ 11904" four a_prime b_prime | sed -f sedaccents > Psalm0118.tex;
./modes.pl "revisedGrailPsalter/Psalm\ 11905" five a_prime b | sed -f sedaccents > Psalm0118.tex;
./modes.pl "revisedGrailPsalter/Psalm\ 11906" six b a_prime | sed -f sedaccents > Psalm0118.tex;
./modes.pl "revisedGrailPsalter/Psalm\ 11907" seven b a | sed -f sedaccents > Psalm0118.tex;
./modes.pl "revisedGrailPsalter/Psalm\ 11908" eight a_prime b | sed -f sedaccents > Psalm0118.tex;
./modes.pl "revisedGrailPsalter/Psalm\ 11909" peregrinus b a | sed -f sedaccents > Psalm0118.tex;
./modes.pl "revisedGrailPsalter/Psalm\ 11910" one a b | sed -f sedaccents > Psalm0118.tex;
./modes.pl "revisedGrailPsalter/Psalm\ 120" four a b | sed -f sedaccents > Psalm0118.tex;
./modes.pl "revisedGrailPsalter/Psalm\ 121"  | sed -f sedaccents > Psalm0119.tex;
./modes.pl "revisedGrailPsalter/Psalm\ 121"  | sed -f sedaccents > Psalm01.tex;
./modes.pl "revisedGrailPsalter/Psalm\ 122"  | sed -f sedaccents > Psalm01.tex;
